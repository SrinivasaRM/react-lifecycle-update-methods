This react application explains how mount and update life cycle methods execute. While executing this application, please monitor the logs by enabling developer-tools in browser and put the log statements in your life cycle methods.
- First this application will load the mount life cycle methods and after 5 seconds,It will load all update life cycle methods. See the order as below.

    - componentWillMount
    - componentDidMount
- After 5 seconds below life cycle methods will be executed.
